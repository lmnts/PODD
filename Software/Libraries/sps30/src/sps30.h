...
// CS 190603: Excessive timeout locks up microcontroller for
// extended period if sensor is not present.  If no I2C bus
// contention, interactions should complete within ~ 20ms.
//#define TIME_OUT    5000                   // timeout to prevent deadlock read
#define TIME_OUT    100                    // timeout to prevent deadlock read
// CS 190603: Delay here does nothing that above timeout does
// not do?
